...
class LWREventsCPT
{
    ...
    public function generateExcel($eventID) {
        ...
        //Autosize on Column
        foreach (range('A:I', $excel->getActiveSheet()
    ...
    function check_post_type_and_remove_media_buttons() {
        ...
        if ('lwrevents' == $current_screen->post_type) remove_action('media_buttons', 'media_buttons');
    }
    ...
    public static function lwr_events_cpt_config() {
        ...
        $labels = array('name' => __('LWR Events'),
        ...
        register_taxonomy("Sportart", 'lwrevents', array("hierarchical" => true,
                                                         "label" => "Sportarten",
    ...
    function lwr_events_add_mbx() {
        add_meta_box('lwr_events_mbx', 'Anlass Details', array($this,
                                                               'lwr_events_mbx'), 'lwrevents', 'normal', 'default');
    }
