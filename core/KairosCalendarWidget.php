 ...
 */
class KairosCalendarWidget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(// Base ID of your widget
                ...
                __('Kairos Kalender Widget', 'kairos'),

                // Widget description
                array(
                        'description' => __('Kairos Events als Kalender ausgeben.', 'kairos'),
                ));
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label><label
                        for="<?php echo $this->get_field_id('numEvents'); ?>"><?php _e('Anzahl Events:'); ?></label>
    ...
    function kairos_load_cal_widget()
    {
        register_widget('KairosCalendarWidget');
    }
} // Class KairosCalendarWidget ends here
