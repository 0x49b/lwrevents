 ...
 * Project:       Kairos
 * Version:       1.8.0.6
 * Description:   Displays a Kairos Event
 */
                    ...
                    if (new DateTime() < new DateTime($lwr->getEventMeta($post->ID, 'lwrAnmelden'))) {
                        ...
                        <?php if (is_user_logged_in()) {
                            ...
                            if ($lwr->checkSignInForEvent($post->ID) == false) {
                                ...
                                <tr>
                                    <td>
                                        <label><input type="radio" class="signInVal"
                                                      name="signInState[]"
                                ...
                                ?>
                                <tr>
                                    <td colspan="2">Anmeldung ist geschlossen, die maximale
                                        Teilnehmerzahl
                                        ist
                                        erreicht.
                                    </td>
                            ...
                            ?>
                            <tr>
                                <td colspan="2">Die Anmeldung steht nur Mitgliedern zur Verfügung.
                                </td>
                            </tr>
                            <?php
                ...
                <?php if ($lwr->getCheckboxStateBool('lwr_signin_for_users') == true || is_user_logged_in()) { ?>
                    ...
                    <table class="lwr-event-detail-user-table">
                        ...
                        <tr class="lwr-event-detail-user-table-third">
                            ...
                            <td class="lwr-event-detail-user-table-title">Ich kann nicht
                                teilnehmen
                            </td>
